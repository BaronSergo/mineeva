...
$(document).ready( function () {
  ...
  // Responsive menu
    var navWrap = ".header__menu .header__menu-holder";
    $('.header__menu').prepend('<span class=\"hamburger\"><span></span></span>');
    $('.hamburger').click(function() {
      $(navWrap).stop().slideToggle(function() {
        $(navWrap).toggleClass('expanded', $(this).is(':visible'));
      });
    });
    $('.header__menu-holder').prepend('<span class=\"close-menu\"><span></span></span>');
...
$(document).ready( function () {
    ...
    var owlHeader = $('.slider .owl-carousel');
    var owlFooter = $('.footer .owl-carousel');
